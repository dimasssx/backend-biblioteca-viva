...
public record EssayRequestDTO(
        ...
        @NotBlank(message = "Rate can not be blank") @Max(value = 1000,message = "Rate must be less than or equal to 1000") @Min(value = 0,message = "Rate must be greater than or equal to 0")
        Integer rate,
